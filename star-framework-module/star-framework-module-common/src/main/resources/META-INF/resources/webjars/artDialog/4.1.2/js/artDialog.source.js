...
artDialog.fn = artDialog.prototype = {
	...
	_init: function (config) {
		var that = this, DOM,
			...
			: {/*backgroundImage: 'url(\'' + config.path + '/skins/icons/' + icon + '.png\')'//取消写入背景图标*/});
		...
		DOM.iconBg[0].src = '' + config.path + '/skins/icons/' + icon + '.png';//用img标签加载图标
		//控制图标div背景 DOM.iconBg.css(iconBg || {background: 'none'});
						...
						'<tbody>' +
							...
							'<tr>' +
								'<td class="aui_icon">' +
									...
									'<img class="aui_iconBg" />' +	//图标改为直接链接图片
								'</td>' +
								'<td class="aui_main">' +
